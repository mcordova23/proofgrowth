...
const TOOLS_SPONSORED = [
  { name: "SuperX", description: "Grow faster on X with smart analytics, hidden insights and...", color: "#FFF3E0", icon: "S", url: "#" },
  { name: "Outrank", description: "Grow organic traffic on autopilot. Get recommended by ChatGPT & Rank...", color: "#FFF8E1", icon: "O", url: "#" },
  { name: "Feather", description: "Use Notion to publish an SEO-friendly blog, collect emails and...", color: "#F3E5F5", icon: "F", url: "#" },
  { name: "PostSyncer", description: "PostSyncer helps you manage all your social accounts. Schedule...", color: "#E3F2FD", icon: "P", url: "#" },
];
// ============================================
// PAGES
// ============================================
